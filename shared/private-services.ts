export const privateServices = [
  ...
  { id: 'all-private', label: 'LP + Agreement', description: 'LP and agreement services. Smart Contract Auditing requires its own key. Excludes video, passports, and helper sponsorship.', paths: ['/api/integrations/intelligence', '/api/integrations/intelligence/readiness', '/api/integrations/polydesk-general-research', '/api/integrations/agreement-intelligence'] },
] as const
