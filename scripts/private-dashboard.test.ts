...
test('private dashboard replaces legacy purchases with bounded key creation', () => {
  ...
  for(const label of ['Helper Sponsorship','Video Scoring','LP Intelligence','Agreement Intelligence','LP + Agreement','Smart Contract Auditing','Service configuration','Platform']) assert(html.includes(label))
