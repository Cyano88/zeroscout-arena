...
- Attribute every form statistic, result, injury and lineup claim to a team explicitly identified in the same supplied passage. A publisher, page title, nearby navigation link, or unresolved 'we', 'our', 'they' or 'their' is not a subject. If the subject is absent or ambiguous, omit the team-specific claim and report an attribution gap. Never flip scores or infer home/away orientation from compressed tables without explicit labels.
