  ...
  return (
    <main className="page-narrow">
      <header className="page-heading">
        ...
        <p>ZeroScout turns a project into a verifiable public profile. The full record lives on 0G. The app only keeps a small index so pages load quickly.</p>
      </header>

      <section className="surface surface-pad docs">
        <h2>What ZeroScout does</h2>
        <p>It takes a builder's repo, demo, and notes and creates a single public proof page. The page includes a brief, a readiness signal, next steps, and ready-to-share copy.</p>
        ...
        <p>The list of profiles you see on the Projects page comes from a small local index used purely for discovery. The index never overrides the canonical record on 0G.</p>

        <h2>How to verify</h2>
        <p>Open any profile, click <code>Verify JSON</code> to fetch the artifact, and compare its <code>content hash</code> against the <code>root</code>. The transaction link opens the 0G explorer for that capsule's storage tx.</p>
